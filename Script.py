...
‣ ᴅᴇᴠᴇʟᴏᴘᴇʀ : <a href='https://t.me/ek4mpreetsingh'>ᴇᴋᴀᴍᴘʀᴇᴇᴛ sɪɴɢʜ</a> 
...
<b>ᴜʀʟ ʙᴜᴛᴛᴏɴꜱ:</b>
<code>[Button Text](buttonurl:https://t.me/galaxy_bots1/3)</code>
<b>ᴀʟᴇʀᴛ ʙᴜᴛᴛᴏɴꜱ:</b>
...
𝗠𝗲𝘀𝘀𝗮𝗴𝗲 <b>: {}</b>"""
    ...
    CAPTION = """<b>☆ғɪʟᴇɴᴀᴍᴇ : @MoviesGalaxy120 <a href="https://t.me/MoviesGalaxy120">{file_name}</a>
<b> ☆sɪᴢᴇ: {file_size}</b>""" 
...
›› ꜱᴛᴇᴘ 4 : ɪꜰ ʏᴏᴜ ᴅᴏɴ'ᴛ ᴜꜱɪɴɢ ᴀɴʏ ꜱʜᴏʀᴛɴᴇʀ ᴡᴇʙꜱɪᴛᴇ ᴛʜᴇɴ ᴍᴀᴋᴇ ᴀᴄᴄᴏᴜɴᴛ ꜰɪʀꜱᴛ ᴏɴ <a href="https://zipshort.net/ref/Ekampreetsingh">zipshort.net</a> (ʏᴏᴜ ᴄᴀɴ ᴀʟꜱᴏ ᴜꜱᴇ ᴏᴛʜᴇʀ ʟɪɴᴋ ꜱʜᴏʀᴛɴᴇʀ ᴡᴇʙꜱɪᴛᴇ).

›› ꜱᴛᴇᴘ 5 : ᴄᴏᴘʏ ʏᴏᴜʀ ᴀᴘɪ ꜰʀᴏᴍ ᴡᴇʙꜱɪᴛᴇ ᴀɴᴅ ᴛʜᴇɴ, ꜱɪᴍᴘʟʏ ꜱᴇᴛ ʏᴏᴜʀ ᴡᴇʙꜱɪᴛᴇ ᴀɴᴅ ᴀᴘɪ ᴜꜱɪɴɢ ᴛʜᴇ /shortlink ᴄᴏᴍᴍᴀɴᴅ.

› ʟɪᴋᴇ ᴛʜɪꜱ :</b>  <code>/shortlink zipshort.net 30dceff579fab7d4ce6f3c05595db0cb56e85529</code>
...
› ʟɪᴋᴇ ᴛʜɪꜱ :</b> <code>/set_tutorial https://t.me/+ntInw10a0RgwOWNl</code>
...
‼️ ᴀғᴛᴇʀ sᴇɴᴅɪɴɢ ᴀ sᴄʀᴇᴇɴsʜᴏᴛ ᴘʟᴇᴀsᴇ ɢɪᴠᴇ ᴜs sᴏᴍᴇ ᴛɪᴍᴇ ᴛᴏ ᴀᴅᴅ ʏᴏᴜ ɪɴ ᴛʜᴇ ᴘʀᴇᴍɪᴜᴍ</b>"""
 ...
 𝖤𝗑𝖺𝗆𝗉𝗅𝖾 :- /country India</b>"""
    ...
    TOP_TRENDING_TXT = """
ʏᴏᴜ ᴄᴀɴ ᴜsᴇ ᴛʜɪs ᴀᴍᴀᴢɪɴɢ ғᴇᴀᴛᴜʀᴇ ᴛᴏ ɢᴇᴛ ᴛʜᴇ ʟɪsᴛ ᴏғ ᴛᴏᴘ 29 ᴛʀᴇɴᴅɪɴɢ ᴍᴏᴠɪᴇs.

⇛ᴊᴜsᴛ sᴇɴᴅ /trending ᴛᴏ ɢᴇᴛ ᴛʜᴇ ʟɪsᴛ.
ᴛʜᴇ ʟɪsᴛ ɪs ғʀᴏᴍ ᴛʜᴇ ᴛᴏᴘ sᴇᴀʀᴄʜᴇs ᴀɴᴅ ɪs ɴᴏᴛ ᴇᴅɪᴛᴇᴅ ʙʏ ᴛᴇ ᴀᴅᴍɪɴ. """

    MOST_DOWNLOAD_TXT = """
ʏᴏᴜ ᴄᴀɴ ᴜsᴇ ᴛʜɪs ᴀᴍᴀᴢɪɴɢ ғᴇᴀᴛᴜʀᴇ ᴛᴏ ɢᴇᴛ ᴛʜᴇ ʟɪsᴛ ᴏғ ᴛᴏᴘ 29 ᴍᴏsᴛ ᴅᴏᴡɴʟᴏᴀᴅᴇᴅ ᴍᴏᴠɪᴇs.

⇛ᴊᴜsᴛ sᴇɴᴅ /most_download ᴛᴏ ɢᴇᴛ ᴛʜᴇ ʟɪsᴛ.
ᴛʜᴇ ʟɪsᴛ ɪs ғʀᴏᴍ ᴛʜᴇ ᴛᴏᴘ sᴇᴀʀᴄʜᴇs ᴀɴᴅ ɪs ɴᴏᴛ ᴇᴅɪᴛᴇᴅ ʙʏ ᴛᴇ ᴀᴅᴍɪɴ. """

    SPECIAL_FEATURES_TXT = """
ʜᴇʀᴇ ᴀʀᴇ ᴛʜᴇ ᴀᴍᴀᴢɪɴɢ sᴘᴇᴄɪᴀʟ ғᴇᴀᴛᴜʀᴇs💫:"""
