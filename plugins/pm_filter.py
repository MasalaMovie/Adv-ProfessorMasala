        ...
        try:
            ...
            if not link:
                ...
                if PM_SEARCH == True:
                    ...
                    await message.reply_text(text=f"<b>ʜᴇʏ {user} 😍 ,\n\nʏᴏᴜ ᴄᴀɴ'ᴛ ɢᴇᴛ ᴍᴏᴠɪᴇs ꜰʀᴏᴍ ʜᴇʀᴇ. ʀᴇǫᴜᴇsᴛ ɪᴛ ɪɴ ᴏᴜʀ <a href=https://t.me/MoviesGalaxy120>ᴍᴏᴠɪᴇ ɢʀᴏᴜᴘ</a> ᴏʀ ᴄʟɪᴄᴋ ʀᴇǫᴜᴇsᴛ ʜᴇʀᴇ ʙᴜᴛᴛᴏɴ ʙᴇʟᴏᴡ 👇</b>", reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("📝 ʀᴇǫᴜᴇsᴛ ʜᴇʀᴇ ", url=f"https://t.me/MoviesGalaxy120")]]))
...
async def filter_yearss_cb_handler(client: Client, query: CallbackQuery):
    ...
    if not files:
        await query.answer("‼️ Nᴏ ғɪʟᴇ ғᴏᴜɴᴅ ‼️", show_alert=1)
        return
    temp.GETALL[key] = files
    settings = await get_settings(message.chat.id)
    pre = 'filep' if settings['file_secure'] else 'file'
    ...
    if offset != "":
        ...
        btn.append(
            [InlineKeyboardButton(text="ɴᴏ ᴍᴏʀᴇ ᴘᴀɢᴇꜱ‼️",callback_data="pages")]
        )
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data == "close_data":
        ...
        if not free_trial_status:            
            ...
            new_text= "**☹️ꜱɪʀ, ʏᴏᴜ ʜᴀᴠᴇ ᴀʟʀᴇᴀᴅʏ ʀᴇᴅᴇᴇᴍᴇᴅ ʏᴏᴜʀ ғʀᴇᴇ 𝟻 ᴍɪɴꜱ ᴛʀɪᴀʟ. ᴋɪɴᴅʟʏ ꜱᴇɴᴅ /plan ᴀɴᴅ ʙᴜʏ ᴀ ᴘʟᴀɴ**"
            await query.message.edit_text(text=new_text)
            return
    ...
    if query.data.startswith("file"):
        ...
        btn2 = [[
                 ...
                 InlineKeyboardButton("Rᴇᴏ̨ᴜᴇsᴛ Gʀᴏᴜᴘ Lɪɴᴋ", url="https://t.me/+mNNvaP82UfQ3OTVl")
               ]]
        if query.from_user.id in ADMINS:
            user = await client.get_users(from_user)
            reply_markup = InlineKeyboardMarkup(btn)
    ...
    # don't change anything without contacting me @kingvj01
        ...
        if PREMIUM_AND_REFERAL_MODE == True:
            buttons = [[
                ...
                InlineKeyboardButton('· ғᴇᴀᴛᴜʀᴇꜱ ·', callback_data='specialfeature_info'),
                InlineKeyboardButton('· ᴀʙᴏᴜᴛ ·', callback_data='about')
            ],[
                InlineKeyboardButton('🥇 ʙᴜʏ ᴘʀᴇᴍɪᴜᴍ: ʀᴇᴍᴏᴠᴇ ᴀᴅꜱ 🥇', callback_data='buypremiuminfo')
            ],[
                InlineKeyboardButton('✨ ʀᴇғᴇʀ ᴘʀᴇᴍɪᴜᴍ ✨', callback_data="subscription"),
        ...
        buttons = [[
            InlineKeyboardButton('📨sᴇɴᴅ ǫᴜᴇʀʏ', user_id=5022283560)
        ],[
        ...
        buttons = [[
            InlineKeyboardButton('✨ᴇxᴛʀᴀ ғᴇᴀᴛᴜʀᴇꜱ✨', callback_data='extrafeature')
        ],[
            InlineKeyboardButton('‼️ ᴜᴘᴅᴀᴛᴇꜱ ᴄʜᴀɴɴᴇʟ ‼️', url="https://t.me/Galaxy_bots1")
        ],[
            InlineKeyboardButton('• ᴄᴏɴᴛᴀᴄᴛ ᴏᴡɴᴇʀ •', url="https://t.me/ek4mpreetsingh"),
            InlineKeyboardButton('• ᴍᴏᴠɪᴇꜱ ᴜᴘᴅᴀᴛᴇꜱ •', url="https://t.me/moviesgalaxy01")
        ],[
            InlineKeyboardButton('📃 ᴍᴏᴠɪᴇꜱ ᴡᴇʙꜱɪᴛᴇ 📃', url="https://litemoviesseries.blogspot.com/")
        ],[
            InlineKeyboardButton('⇌ʙᴀᴄᴋ ᴛᴏ ʜᴏᴍᴇ⇌', callback_data='start')
        ]]
        await client.edit_message_media(
        ...
        buttons = [[
            InlineKeyboardButton('🆎ғᴏɴᴛ', callback_data='font_info'),
            InlineKeyboardButton('☁️ᴛᴇʟᴇɢʀᴀᴘʜ', callback_data='tele')
        ],[
            InlineKeyboardButton('🖼️ꜱᴛɪᴄᴋᴇʀ ɪᴅ', callback_data='sticker'),
            InlineKeyboardButton('📄ᴄᴏᴜɴᴛʀʏ ɪɴғᴏ', callback_data='country')
        ],[
    ...
    elif query.data == "buypremiuminfo":
            btn = [[
            InlineKeyboardButton("📞 sᴇɴᴅ ᴘᴀʏᴍᴇɴᴛ ᴘʀᴏᴏꜰ 📞", user_id=5022283560)
            ],[
            InlineKeyboardButton('⇋ ʙᴀᴄᴋ ᴛᴏ ʜᴏᴍᴇ ⇋', callback_data='start')
            ]]
            await client.edit_message_media(
        ...
        await query.message.edit_text(
            ...
            btn = [[
                    InlineKeyboardButton("⟸ Bᴀᴄᴋ", callback_data="help"),
                    InlineKeyboardButton("Cᴏɴᴛᴀᴄᴛ", url="telegram.me/EK4MPREETSINGH")
                  ]]
            await client.edit_message_media(
                query.message.chat.id, 
                query.message.id, 
    ...
    elif query.data == "specialfeature_info":
        buttons = [[
            InlineKeyboardButton('⚡ᴛʀᴇɴᴅɪɴɢ ᴍᴏᴠɪᴇs', callback_data='trending_info')
        ],[
            InlineKeyboardButton('📥ᴍᴏsᴛ ᴅᴏᴡɴʟᴏᴀᴅᴇᴅ ᴍᴏᴠɪᴇs', callback_data='mostdown_info')
        ],[
            InlineKeyboardButton('⇋ʙᴀᴄᴋ ᴛᴏ ʜᴏᴍᴇ⇋', callback_data='start')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        ...
        await query.message.edit_text(
            text=script.SPECIAL_FEATURES_TXT,
            reply_markup=reply_markup,
            parse_mode=enums.ParseMode.HTML
        )
    elif query.data == "trending_info":
        buttons = [[
            InlineKeyboardButton('⇚ʙᴀᴄᴋ', callback_data='specialfeature_info')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await client.edit_message_media(
            query.message.chat.id, 
        ...
        await query.message.edit_text(
            text=script.TOP_TRENDING_TXT,
            reply_markup=reply_markup,
            parse_mode=enums.ParseMode.HTML
        )
    elif query.data == "mostdown_info":
        buttons = [[
            InlineKeyboardButton('⇚ʙᴀᴄᴋ', callback_data='specialfeature_info')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
...
async def advantage_spell_chok(client, name, msg, reply_msg, vj_search):
    ...
    if AI_SPELL_CHECK == True and vj_search == True:
        vj_search_new = False
        vj_ai_msg = await reply_msg.edit_text("<b><i>🤖ᴄʜᴇᴄᴋɪɴɢ ꜱᴘᴇʟʟɪɴɢ ᴡɪᴛʜ ᴀᴅᴠᴀɴᴄᴇᴅ AI</i></b>")
        movienamelist = []
